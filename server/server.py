# Built-in modules
import sys
sys.path.append('C:\\Users\\yucelm\\Desktop\\urop23_server_client') # depending on the name of the folder the drivers are in, update this!
import os, time, json, logging, socket
from multiprocessing import Process, Queue
from queue import Empty as QueueEmpty
# Custom modules
import utils, loggingProc, worker
        ...
        if msg['name'] is None or msg['name'] == '_ping': # "ping request"
            ...
            if msg['name'] in MODULES:
                if MODULES[msg['name']][1][0].is_alive():
                    # this is the very first ack message to ensure the connection has been established, and the corresponding worker is alive
...
if __name__ == '__main__':
    ...
    server_addr = '18.25.23.240'
    server_port = 36577
    print('THIS IS SYSTEM PATH: ', sys.path)
    main('server_test', config_path, server_addr=server_addr, server_port=server_port, logfile=logfile)